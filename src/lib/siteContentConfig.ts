    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: "barber4_name", label: "ספר 4 - שם", type: "text", defaultValue: "עידן" },
          { key: "barber4_name_en", label: "ספר 4 - שם באנגלית", type: "text", defaultValue: "IDAN" },
          { key: "barber4_image", label: "ספר 4 - תמונה", type: "image", defaultValue: "" },
          { key: "barber4_prices", label: "ספר 4 - מחירים (מופרד בפסיקים)", type: "text", defaultValue: "70,80,70,100" },
