        ...
        <AnimatedSection>
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center gap-3 justify-center mb-6">
              ...
              <h2 className="mb-0">איך Macho הפכה למובילה בפרם לגברים בישראל</h2>
              <Trophy className="w-8 h-8 text-accent" />
            </div>
            <div className="space-y-4 text-lg opacity-85 text-center">
              <p>{v("our_story", "paragraph1", "כשכולם עוד חשבו שפרם זה \"דבר של פעם\" - אנחנו כבר ראינו לאן הדברים הולכים. נסענו לחו\"ל. למדנו מהטובים בעולם. חזרנו עם טכנולוגיות שעוד לא היו פה - ופיתחנו שיטות שמותאמות בדיוק לשיער ולאקלים הישראלי.")}</p>
              <p>{v("our_story", "paragraph2", "היום, מאות גברים שהגיעו אלינו עם שיער שטוח וחסר אופי - יוצאים עם לוק שהפך לחלק מהזהות שלהם. אנחנו לא סתם עושים פרם. אנחנו האנשים שהביאו את זה לישראל ברצינות.")}</p>
              <p className="text-2xl font-black" style={{ color: '#C9A84C' }}>{v("our_story", "tagline", "🛡️ הניסיון שלנו הוא הביטוח שלכם.")}</p>
            </div>
          </div>
        </AnimatedSection>
      </Section>
