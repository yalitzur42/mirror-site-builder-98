...
const ChemistryCoursePage = () => {
  const modules = ["בסיס כימיה של שיער", "תורת הצבע והגוונים", "טכניקות צביעה מתקדמות", "הבהרה והכהיה", "תיקון צבע", "שימוש במוצרים מקצועיים"];

  return (
    <Layout>
      <Breadcrumbs items={[{ label: "האקדמיה", href: "/academy" }, { label: "קורס כימיה וצבע" }]} />
      ...
      <Section variant="light">
        <AnimatedSection>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg opacity-80 mb-6">צביעת שיער היא אמנות ומדע. בקורס הזה תלמדו את שניהם – ותצאו עם היכולת ליצור כל גוון שהלקוח מבקש.</p>
            <a href="https://wa.me/972552935987?text=היי+אני+אשמח+לשמוע+עוד+פרטים+על+הקורס+כימיה+וצבע" target="_blank" rel="noopener noreferrer" className="whatsapp-cta">
