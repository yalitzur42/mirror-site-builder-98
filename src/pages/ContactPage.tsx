...
import { Phone, Mail, MessageCircle, Handshake, Zap, FileText } from "@/lib/icons";
      ...
      <div className="section-light">
        <section className="relative py-16 md:py-24 overflow-hidden rounded-b-[40px] md:rounded-b-[80px]">
          ...
          <div className="container-main text-center relative z-10">
            <h1 className="hero-title-animate mb-4" style={{ color: "hsl(var(--primary))" }}>רוצים לעבוד איתנו?</h1>
